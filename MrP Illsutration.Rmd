...
author: Lucas Leemann and Fabio Wasserfallen -- Illustrative Example, Book Chapter
  for the Sage Handbook of Research Methods in Political Science and International
  Relations
date: "10/5/2018"
output:
...
plot(seq(.31,.8,length.out=26),1:26, bty="n", pch=20, yaxt="n",
     xlab="Support for Initiative", ylab="", col="white")
